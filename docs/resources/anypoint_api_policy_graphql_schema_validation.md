---
page_title: "anypoint_api_policy_graphql_schema_validation Resource - terraform-provider-anypoint"
subcategory: "API Policies"
description: |-
  Manages a GraphQL Schema Validation policy on an Anypoint API instance.
---

# anypoint_api_policy_graphql_schema_validation (Resource)

Manages a GraphQL Schema Validation policy on an Anypoint API instance. This policy validates incoming GraphQL operations against the GraphQL schema.
...
```terraform
resource "anypoint_api_policy_graphql_schema_validation" "example" {
...
- `block_operation` (Boolean) Whether to block operations that fail schema validation. Defaults to `true`.
...
An existing `anypoint_api_policy_graphql_schema_validation` policy can be imported using its composite ID: `organization_id/environment_id/api_instance_id/policy_id`.
...
```terraform
import {
  to = anypoint_api_policy_graphql_schema_validation.imported
  id = "<organization_id>/<environment_id>/<api_instance_id>/<policy_id>"
}

resource "anypoint_api_policy_graphql_schema_validation" "imported" {
...
```shell
terraform import anypoint_api_policy_graphql_schema_validation.imported <organization_id>/<environment_id>/<api_instance_id>/<policy_id>
```
