...
variable "private_space_id" {
  description = "The ID of the private space for which to configure firewall rules"
  type        = string
}

variable "organization_id" {
  description = "The ID of the organization for which to configure firewall rules"
  type        = string
}