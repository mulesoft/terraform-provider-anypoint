...
└── security/            # Credential-injection patterns (AWS Secrets Manager,
                         # Vault, Terraform Cloud, GitHub Actions)
```

> **📖 Security guidance:** before copying any of these examples into a
> production config, read [`docs/SECURITY.md`](../docs/SECURITY.md) for the
> credential-storage and state-hygiene requirements. See
> [`examples/security/`](./security/) for working credential-injection
> patterns.
