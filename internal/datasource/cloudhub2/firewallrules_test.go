...
func TestNewFirewallRulesDataSource(t *testing.T) {
	dataSource := NewFirewallRulesDataSource()

	if dataSource == nil {
		t.Error("NewFirewallRulesDataSource() returned nil")
	}
...
func TestFirewallRulesDataSource_Metadata(t *testing.T) {
	...
	if resp.TypeName != "test_firewallrules" {
		t.Errorf("Metadata() TypeName = %v, want %v", resp.TypeName, "test_firewallrules")
	}
}
...
func TestFirewallRulesDataSource_Configure(t *testing.T) {
	dataSource := NewFirewallRulesDataSource().(*FirewallRulesDataSource)
...
func TestFirewallRulesDataSourceModel_Validation(t *testing.T) {
	model := FirewallRulesDataSourceModel{}
	_ = model.ID
}

func BenchmarkFirewallRulesDataSource_Schema(b *testing.B) {
	dataSource := NewFirewallRulesDataSource()
	ctx := context.Background()
	req := datasource.SchemaRequest{}
