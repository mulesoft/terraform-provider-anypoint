...
func TestMCPServerResource_ValidateConfig_ResponseTimeoutOmniGateway(t *testing.T) {
	res := NewMCPServerResource().(*MCPServerResource)
	ctx := context.Background()
...
func TestMCPServerResource_ImportState_Valid(t *testing.T) {
	res := NewMCPServerResource().(*MCPServerResource)
	ctx := context.Background()
	...
	req := resource.ImportStateRequest{ID: "test-org/test-env/200"}
	...
	if got.ID.ValueString() != "200" {
		t.Errorf("expected id '200', got '%s'", got.ID.ValueString())
	}
}

func TestMCPServerResource_ImportState_Invalid(t *testing.T) {
	res := NewMCPServerResource().(*MCPServerResource)
	ctx := context.Background()
