...
func (p *AnypointProvider) Resources(_ context.Context) []func() resource.Resource {
	...
	resources = append(resources, []func() resource.Resource{
		...
		resourceAccessManagement.NewRolePermissionResource,
		resourceAccessManagement.NewRoleUsersResource,
...
func (p *AnypointProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	dataSources := []func() datasource.DataSource{
		...
		dsAccessManagement.NewTeamMembersDataSource,
		dsAccessManagement.NewTeamRolesDataSource,
